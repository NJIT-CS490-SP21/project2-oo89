...
class TestAppListUS(unittest.TestCase):
    ...
    def test_addUsersScoresToLists(self):
        for test in self.success_test_params:
            actual_usersList, actual_scoreList = addUsersScoresToLists(test[KEY_INPUT])
