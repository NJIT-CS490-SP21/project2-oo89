...
from app import updateWinnerLoser
import models
        ...
        for name in self.initial_db_mock:
            if name.username == winnerName:
                ...
                self.initial_db_mock[
                    i].score = self.initial_db_mock[i].score + 1
                print(name.score)
                break
            i += 1
        return self.initial_db_mock
                ...
                with patch('app.db.session.query') as mocked_query:
                    ...
                    with patch('app.db.session.commit',
                        ...
                        with patch('models.Person.query') as mocked_query:
                            ...
                            actual_userLResult, actual_scoresLResult = updateWinnerLoser(
                                test[KEY_INPUT][0], test[KEY_INPUT][1])
                            print('actual')
